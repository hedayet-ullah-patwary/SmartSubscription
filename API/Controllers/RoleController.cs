...
namespace API.Controllers
{
    public class RoleController : Controller
    {
        ...
        public IActionResult Create(RoleDTO role)
        {
            ...
            if (!ModelState.IsValid) { TempData["Error"] = "Invalid input"; return RedirectToAction("Index"); }
        ...
        public IActionResult Edit(int id)
        {
            ...
            if (role == null) { TempData["Error"] = "Role not found."; return RedirectToAction("Index"); }
            return View(role);
        }
        ...
        public IActionResult Edit(RoleDTO role)
        {
            ...
            if (!ModelState.IsValid) { ViewBag.Error = "Invalid input"; return View(role); }
